...
**Option 1: Download Release (Recommended)**
1. Download `paprwall-v1.0.0-windows-x64.zip` from [Releases](https://github.com/riturajprofile/paprwall/releases)
2. Extract the ZIP file
3. Run `INSTALL.bat` as normal user (not administrator)
4. Find "PaprWall" in Start Menu
